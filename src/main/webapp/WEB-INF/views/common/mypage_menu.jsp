...
<link rel="stylesheet" href="/css/mypage/top_mini.css">
...
<div id="main_nav_wrap">
	<div id="main_nav">
		<ul>
			...
			<li id="main_nav_2"><a href="/mypage/cart" class="primary-btn">장바구니</a></li>
		
			<li id="main_nav_3"><a href="/mypage/modify" class="primary-btn">회원정보 수정</a></li>
